...
const regionCenters = useMemo(() => {
  ...
  const getFillColor = useCallback((regionId: string) => {
    ...
    if (hoveredRegion === regionId) return hoverFillColor;
        ...
        >
          ...
          <g className="cls-2 state" id="tigrayl">
            <polygon
              ...
              fill={getFillColor("tigray")}
              className={`state ${selectedRegion === "tigray" ? "active" : ""}`}
              onClick={() => handleRegionClick("tigray")}
          ...
          {/* Addis Ababa Region */}
          <g className="cls-2 state" id="addisababal">
            <polygon
              id="addis_ababa"
              ...
              fill={getFillColor("addis_ababa")}
              className={`state ${selectedRegion === "addis_ababa" ? "active" : ""}`}
              onClick={() => handleRegionClick("addis_ababa")}
            ...
            {showValues && regionData["addis_ababa"]?.value !== undefined && (
              <text
                x={regionCenters.addis_ababa.x}
                y={regionCenters.addis_ababa.y + 10}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
          ...
          <g className="cls-2 state" id="hararl">
            <polygon
              ...
              fill={getFillColor("harar")}
              className={`state ${selectedRegion === "harar" ? "active" : ""}`}
              onClick={() => handleRegionClick("harar")}
            ...
            {showValues && regionData["harar"]?.value !== undefined && (
              <text
                x={regionCenters.harar.x}
                y={regionCenters.harar.y + 10}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
          ...
          {/* Oromiya */}
          <g className="cls-2 state" id="oromiyal">
            <g id="oromiya">
              <path
                d="M149.3,238.1l1.558-4.664A23.219,23.219,0,0,0,149.3,238.1Z"
                transform="translate(-1.298 -2.58)"
                fill={getFillColor("oromiya")}
                className={`state ${selectedRegion === "oromiya" ? "active" : ""}`}
                onClick={() => handleRegionClick("oromiya")}
                onMouseEnter={() => handleRegionHover("oromiya")}
                onMouseLeave={() => handleRegionHover(null)}
              />
              <line
                x1="158.786"
              ...
              />
              <polygon
                points="160.018 243.478 160.107 243.629 161.092 244.411 160.018 243.478"
                fill={getFillColor("oromiya")}
                className={`state ${selectedRegion === "oromiya" ? "active" : ""}`}
                onClick={() => handleRegionClick("oromiya")}
              />
              <polygon
                points="146.139 237.304 147.861 235.935 147.893 235.838 146.139 237.304"
                fill={getFillColor("oromiya")}
                className={`state ${selectedRegion === "oromiya" ? "active" : ""}`}
                onClick={() => handleRegionClick("oromiya")}
              />
          ...
          <g className="cls-2 state" id="snprl">
            ...
            {showValues && regionData["snnpr"]?.value !== undefined && (
              <text
                x={regionCenters.snnpr.x}
                y={regionCenters.snnpr.y + 15}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
                {valueFormatter(regionData["snnpr"].value)}
              </text>
            )}
            <polygon
          ...
          {/* Somalia */}
          <g className="cls-2 state" id="somalial">
            <g id="somalia">
              <polygon
            ...
            {showValues && regionData["somalia"]?.value !== undefined && (
              <text
                x={regionCenters.somalia.x}
                y={regionCenters.somalia.y + 15}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
                {valueFormatter(regionData["somalia"].value)}
              </text>
            )}
          </g>

          {/* Amhara */}
          <g className="cls-2 state" id="amharal">
            <polygon
              id="amhara"
            ...
            {showValues && regionData["amhara"]?.value !== undefined && (
              <text
                x={regionCenters.amhara.x}
                y={regionCenters.amhara.y + 15}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
                {valueFormatter(regionData["amhara"].value)}
              </text>
            )}
          </g>

          {/* Afar */}
          <g className="cls-2 state" id="afarl">
            <polygon
              id="afar"
              ...
              fill={getFillColor("afar")}
              className={`state ${selectedRegion === "afar" ? "active" : ""}`}
              onClick={() => handleRegionClick("afar")}
            ...
            {showValues && regionData["afar"]?.value !== undefined && (
              <text
                x={regionCenters.afar.x}
                y={regionCenters.afar.y + 10}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
                {valueFormatter(regionData["afar"].value)}
              </text>
            )}
          </g>

          {/* Dire */}
          <g className="cls-2 state" id="direl">
            <polygon
              id="dire"
              ...
              fill={getFillColor("dire")}
              className={`state ${selectedRegion === "dire" ? "active" : ""}`}
              onClick={() => handleRegionClick("dire")}
            ...
            {showValues && regionData["dire"]?.value !== undefined && (
              <text
                x={regionCenters.dire.x}
                y={regionCenters.dire.y + 10}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
                {valueFormatter(regionData["dire"].value)}
              </text>
            )}
          </g>

          {/* Sidama */}
          <g className="cls-2 state" id="sidamal">
            <polygon
              id="sidama"
              ...
              fill={getFillColor("sidama")}
              className={`state ${selectedRegion === "sidama" ? "active" : ""}`}
              onClick={() => handleRegionClick("sidama")}
            ...
            {showValues && regionData["sidama"]?.value !== undefined && (
              <text
                x={regionCenters.sidama.x}
                y={regionCenters.sidama.y + 10}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
                {valueFormatter(regionData["sidama"].value)}
              </text>
            )}
          </g>

          {/* Gambella */}
          <g className="cls-2 state" id="gambellal">
            <polygon
              id="gambella"
              ...
              fill={getFillColor("gambella")}
              className={`state ${selectedRegion === "gambella" ? "active" : ""}`}
              onClick={() => handleRegionClick("gambella")}
            ...
            {showValues && regionData["gambella"]?.value !== undefined && (
              <text
                x={regionCenters.gambella.x}
                y={regionCenters.gambella.y + 10}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
                {valueFormatter(regionData["gambella"].value)}
              </text>
            )}
          </g>

          {/* Benishangul */}
          <g className="cls-2 state" id="benishangull">
            <polygon
              id="benishangul"
              ...
              fill={getFillColor("benishangul")}
              className={`state ${selectedRegion === "benishangul" ? "active" : ""}`}
              onClick={() => handleRegionClick("benishangul")}
            ...
            {showValues && regionData["benishangul"]?.value !== undefined && (
              <text
                x={regionCenters.benishangul.x}
                y={regionCenters.benishangul.y + 15}
                className={labelClassName}
                textAnchor="middle"
                dominantBaseline="middle"
              >
                {valueFormatter(regionData["benishangul"].value)}
              </text>
            )}
          </g>
        </svg>
