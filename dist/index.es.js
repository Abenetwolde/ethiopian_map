import r1, { useState as n1, useCallback as K, useMemo as t1 } from "react";
var Y = { exports: {} }, O = {};
/**
 * @license React
...
function i1() {
  ...
  function k(t, h, v) {
    var A = null;
    if (v !== void 0 && (A = "" + v), h.key !== void 0 && (A = "" + h.key), "key" in h) {
      v = {};
      for (var N in h)
        N !== "key" && (v[N] = h[N]);
    } else v = h;
  ...
  return O.Fragment = _, O.jsx = k, O.jsxs = k, O;
}
var $ = {};
/**
 * @license React
...
function s1() {
  return D || (D = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function k(e) {
      ...
      if (n) {
        n = console;
        var o = n.error, m = typeof Symbol == "function" && Symbol.toStringTag && e[Symbol.toStringTag] || e.constructor.name || "Object";
        return o.call(
          n,
    ...
    function P(e, n, o, m, E, b, F, X) {
      ...
      if (j.call(n, "key")) {
        f = i(e);
        var M = Object.keys(n).filter(function(a1) {
          return a1 !== "key";
        });
        m = 0 < M.length ? "{key: someKey, " + M.join(": ..., ") + ": ...}" : "{key: someKey}", u[f + m] || (M = 0 < M.length ? "{" + M.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (f = null, o !== void 0 && (k(o), f = "" + o), A(n) && (k(n.key), f = "" + n.key), "key" in n) {
        o = {};
        for (var Q in n)
          Q !== "key" && (o[Q] = n[Q]);
      } else o = n;
    ...
    var g = r1, w = Symbol.for("react.transitional.element"), B = Symbol.for("react.portal"), T = Symbol.for("react.fragment"), L = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), U = Symbol.for("react.consumer"), H = Symbol.for("react.context"), q = Symbol.for("react.forward_ref"), z = Symbol.for("react.suspense"), G = Symbol.for("react.suspense_list"), y = Symbol.for("react.memo"), l = Symbol.for("react.lazy"), C = Symbol.for("react.activity"), p = Symbol.for("react.client.reference"), x = g.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, j = Object.prototype.hasOwnProperty, J = Array.isArray, c = console.createTask ? console.createTask : function() {
      return null;
    };
    g = {
    ...
    var s, S = {}, r = g["react-stack-bottom-frame"].bind(
      g,
      v
    )(), d = c(t(v)), u = {};
    $.Fragment = T, $.jsx = function(e, n, o, m, E) {
...
var e1;
function l1() {
  return e1 || (e1 = 1, process.env.NODE_ENV === "production" ? Y.exports = i1() : Y.exports = s1()), Y.exports;
}
var a = l1();
const o1 = [
  {
  ...
  strokeColor: N = "#808080",
  activeStrokeColor: Z = "#FFFFFF",
  strokeWidth: W = 1,
  activeStrokeWidth: P = 2,
  hoverOpacity: R = 0.9,
  className: g = "flex flex-col lg:flex-row gap-4 p-4",
  ...
  labelClassName: l = "text-xs font-medium fill-current",
  labelPosition: C = "center",
  showValues: p = !1,
  valueFormatter: x = (j) => j.toString()
}) => {
  const [j, J] = n1(null), c = K((u) => {
    _((e) => e === u ? null : u), T?.(u);
  }, [_, T]), s = K((u) => {
    J(u), B?.(u);
  }, [B]), S = (u) => {
    const e = u.split(" ").map((m) => {
      const [E, b] = m.split(",").map(Number);
      return { x: E, y: b };
    });
    let n = 0, o = 0;
    for (const m of e)
    ...
    return k.forEach((e) => {
      if (C === "centroid")
        ...
        u[e.id] = n[e.id] || S(e.points);
      }
    }), u;
  }, [k, C]), d = K((u) => i === u ? v : j === u ? A : t[u]?.color || h, [i, j, t, h, v, A]);
    ...
    /* @__PURE__ */ a.jsxs("div", { className: "w-full h-full relative", children: [
      /* @__PURE__ */ a.jsxs(
        "svg",
        {
          ...
          width: I,
          height: U,
          style: { transform: q ? `scale(${z})` : "none" },
          children: [
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "tigrayl", children: [
              ...
              y && /* @__PURE__ */ a.jsx(
                "text",
                {
                  ...
                  children: t.tigray?.label || "tigray"
                }
              ),
              p && t.tigray?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.tigray.x,
                  y: r.tigray.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "addisababal", children: [
              ...
              p && t.addis_ababa?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.addis_ababa.x,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "hararl", children: [
              ...
              p && t.harar?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.harar.x,
                  y: r.harar.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "oromiyal", children: [
              ...
              p && t.oromiya?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.oromiya.x,
                  y: r.oromiya.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "snprl", children: [
              ...
              p && t.snnpr?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.snnpr.x,
                  y: r.snnpr.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "somalial", children: [
              ...
              p && t.somalia?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.somalia.x,
                  y: r.somalia.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "amharal", children: [
              ...
              p && t.amhara?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.amhara.x,
                  y: r.amhara.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "afarl", children: [
              ...
              p && t.afar?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.afar.x,
                  y: r.afar.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "direl", children: [
              ...
              p && t.dire?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.dire.x,
                  y: r.dire.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "sidamal", children: [
              ...
              p && t.sidama?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.sidama.x,
                  y: r.sidama.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "gambellal", children: [
              ...
              p && t.gambella?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.gambella.x,
                  y: r.gambella.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "benishangull", children: [
              ...
              p && t.benishangul?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.benishangul.x,
      ...
      L && j && /* @__PURE__ */ a.jsx("div", { className: "absolute top-0 left-0 bg-white p-2 rounded shadow", children: L(j, t[j]) })
    ] }),
