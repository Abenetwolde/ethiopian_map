import r1, { useState as s1, useCallback as M, useMemo as n1 } from "react";
var W = { exports: {} }, O = {};
/**
 * @license React
...
function l1() {
  ...
  function _(n, f, v) {
    var k = null;
    if (v !== void 0 && (k = "" + v), f.key !== void 0 && (k = "" + f.key), "key" in f) {
      v = {};
      for (var A in f)
        A !== "key" && (v[A] = f[A]);
    } else v = f;
  ...
  return O.Fragment = E, O.jsx = _, O.jsxs = _, O;
}
var $ = {};
/**
 * @license React
...
function i1() {
  return D || (D = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function P(e, r, l, m, p, j, X, Q) {
      ...
      if (S.call(r, "key")) {
        x = i(e);
        var T = Object.keys(r).filter(function(a1) {
          return a1 !== "key";
        });
        m = 0 < T.length ? "{key: someKey, " + T.join(": ..., ") + ": ...}" : "{key: someKey}", Z[x + m] || (T = 0 < T.length ? "{" + T.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (x = null, l !== void 0 && (_(l), x = "" + l), k(r) && (_(r.key), x = "" + r.key), "key" in r) {
        l = {};
        for (var C in r)
          C !== "key" && (l[C] = r[C]);
      } else l = r;
    ...
    var N = r1, w = Symbol.for("react.transitional.element"), B = Symbol.for("react.portal"), g = Symbol.for("react.fragment"), o = Symbol.for("react.strict_mode"), H = Symbol.for("react.profiler"), q = Symbol.for("react.consumer"), z = Symbol.for("react.context"), G = Symbol.for("react.forward_ref"), J = Symbol.for("react.suspense"), F = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), K = Symbol.for("react.activity"), y = Symbol.for("react.client.reference"), u = N.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, S = Object.prototype.hasOwnProperty, L = Array.isArray, b = console.createTask ? console.createTask : function() {
      return null;
    };
    N = {
    ...
    var Y, c = {}, t = N["react-stack-bottom-frame"].bind(
      N,
      v
    )(), s = b(n(v)), Z = {};
    $.Fragment = g, $.jsx = function(e, r, l, m, p) {
      ...
      return P(
        ...
        m,
        p,
        j ? Error("react-stack-top-frame") : t,
        j ? b(n(e)) : s
      );
    }, $.jsxs = function(e, r, l, m, p) {
      var j = 1e4 > u.recentlyCreatedOwnerStacks++;
      return P(
        e,
        r,
...
var e1;
function t1() {
  return e1 || (e1 = 1, process.env.NODE_ENV === "production" ? W.exports = l1() : W.exports = i1()), W.exports;
}
var a = t1();
const o1 = [
  {
  ...
  regions: _ = o1,
  regionData: n = {},
  defaultFillColor: f = "#00C4B4",
  activeFillColor: v = "#40E0D0",
  hoverFillColor: k = "#40E0D0",
  strokeColor: A = "#ffffff",
  activeStrokeColor: I = "#FFFFFF",
  strokeWidth: U = 1,
  activeStrokeWidth: P = 2,
  hoverOpacity: R = 0.9,
  className: N = "flex flex-col lg:flex-row gap-4 p-4",
  ...
  width: H = "100%",
  height: q = "auto",
  viewBox: z = "0 0 441.853 328.295",
  enableZoom: G = !1,
  zoomLevel: J = 1,
  customStyles: F = "",
  showRegionLabels: h = !1,
  labelClassName: d = "text-xs font-medium fill-current",
  labelPosition: K = "center",
  showValues: y = !1,
  valueFormatter: u = (b) => b.toString(),
  defaultLabelStyle: S = {},
  defaultValueStyle: L = {}
}) => {
  const [b, Y] = s1(null), c = M((l) => {
    E((m) => m === l ? null : l), g?.(l);
  }, [E, g]), t = M((l) => {
    Y(l), B?.(l);
  }, [B]), s = n1(() => {
    ...
    ...n[l]?.valueStyle || {}
  }), [n, L]), r = M((l) => i === l ? v : b === l ? k : n[l]?.color || f, [i, b, n, f, v, k]);
  return /* @__PURE__ */ a.jsxs("div", { className: N, children: [
    /* @__PURE__ */ a.jsxs("div", { className: "w-full h-full relative", children: [
      /* @__PURE__ */ a.jsxs(
        "svg",
        {
          ...
          width: H,
          height: q,
          style: { transform: G ? `scale(${J})` : "none" },
          children: [
            /* @__PURE__ */ a.jsx("style", { children: `
              ...
              ${F}
            ` }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "tigrayl", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "tigray",
                  ...
                  onClick: () => c("tigray"),
                  onMouseEnter: () => t("tigray"),
                  onMouseLeave: () => t(null)
                }
              ),
              o && /* @__PURE__ */ a.jsx("title", { children: o("tigray", n.tigray) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.tigray.x,
              ...
              y && n.tigray?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.tigray.x,
                  y: s.tigray.y + 35,
                  ...
                  dominantBaseline: "middle",
                  style: e("tigray"),
                  children: u(n.tigray.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "addisababal", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "addis_ababa",
                  ...
                  onClick: () => c("addis_ababa"),
                  onMouseEnter: () => t("addis_ababa"),
                  onMouseLeave: () => t(null)
                }
              ),
              o && /* @__PURE__ */ a.jsx("title", { children: o("addis_ababa", n.addis_ababa) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.addis_ababa.x,
              ...
              y && n.addis_ababa?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.addis_ababa.x,
                  y: s.addis_ababa.y + 10,
                  className: d,
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.addis_ababa.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "hararl", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "harar",
                  ...
                  onClick: () => c("harar"),
                  onMouseEnter: () => t("harar"),
                  onMouseLeave: () => t(null)
                }
              ),
              o && /* @__PURE__ */ a.jsx("title", { children: o("harar", n.harar) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.harar.x,
              ...
              y && n.harar?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.harar.x,
                  y: s.harar.y + 10,
                  ...
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.harar.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "oromiyal", children: [
              /* @__PURE__ */ a.jsxs("g", { id: "oromiya", children: [
                /* @__PURE__ */ a.jsx(
                  "path",
                  {
              ...
              o && /* @__PURE__ */ a.jsx("title", { children: o("oromiya", n.oromiya) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.oromiya.x,
              ...
              y && n.oromiya?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.oromiya.x,
                  y: s.oromiya.y + 15,
                  ...
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.oromiya.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "snprl", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  points: "168.699 190.207 165.049 183.979 162.192 183.54 159.555 189.253 157.797 188.374 155.553 185.291 150.545 184.638 145.49 186.836 136.467 186.386 133.717 184.008 131.536 187.492 133.249 189.118 136.324 189.879 136.041 197.384 134.283 197.824 132.427 196.38 129.668 197.384 131.139 198.878 130.107 201.559 130.767 206.394 131.605 209.536 130.547 213.646 122.855 218.7 113.224 218.808 104.983 213.737 99.781 213.646 98.023 211.668 95.606 211.229 92.529 209.031 90.112 209.69 89.672 205.076 84.398 201.559 85.717 200.241 85.057 194.527 81.761 193.209 80.443 195.626 82.711 198.307 81.269 200.476 76.889 201.727 72.971 200.021 66.818 205.076 67.03 211.333 70.098 213.617 69.256 220.345 62.713 221.29 59.026 219.401 58.684 221.29 53.218 221.865 51.012 224.359 46.792 224.646 42.01 222.827 36.69 222.916 52.204 236.058 56.245 237.653 58.903 240.098 58.588 252.15 59.703 255.378 60.057 258.148 63.474 263.169 63.262 264.977 69.109 269.123 68.684 271.675 68.775 272.763 73.642 270.94 83.356 272.632 84.632 274.227 84.391 277.551 82.825 284.965 82.612 290.387 90.055 298.787 109.011 298.253 112.966 293.418 115.603 287.484 114.944 280.892 118.021 276.716 124.833 276.497 128.789 278.035 139.117 273.86 144.392 276.277 145.71 274.739 144.172 272.321 146.589 269.684 146.809 264.19 149.666 263.971 150.545 261.553 146.809 255.4 141.974 253.862 140.876 251.664 142.853 247.928 142.634 242.434 141.535 240.237 147.313 236.491 148.013 235.653 149.779 230.153 150.865 228.607 150.25 226.146 150.984 219.36 156.259 215.404 159.994 210.57 161.093 204.636 166.367 194.967 164.829 190.352 168.345 192.55 168.699 190.207",
                  ...
                  onClick: () => c("snnpr"),
                  onMouseEnter: () => t("snnpr"),
                  onMouseLeave: () => t(null)
                }
              ),
              o && /* @__PURE__ */ a.jsx("title", { children: o("snnpr", n.snnpr) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.snnpr.x,
              ...
              y && n.snnpr?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.snnpr.x,
                  y: s.snnpr.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "somalial", children: [
              /* @__PURE__ */ a.jsxs("g", { id: "somalia", children: [
                /* @__PURE__ */ a.jsx(
                  "polygon",
                  {
              ...
              o && /* @__PURE__ */ a.jsx("title", { children: o("somalia", n.somalia) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.somalia.x,
              ...
              y && n.somalia?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.somalia.x,
                  y: s.somalia.y + 15,
                  ...
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.somalia.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "amharal", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "amhara",
                  ...
                  onClick: () => c("amhara"),
                  onMouseEnter: () => t("amhara"),
                  onMouseLeave: () => t(null)
                }
              ),
              o && /* @__PURE__ */ a.jsx("title", { children: o("amhara", n.amhara) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.amhara.x,
              ...
              y && n.amhara?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.amhara.x,
                  y: s.amhara.y + 15,
                  ...
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.amhara.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "afarl", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "afar",
              ...
              o && /* @__PURE__ */ a.jsx("title", { children: o("afar", n.afar) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.afar.x,
              ...
              y && n.afar?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.afar.x,
                  y: s.afar.y + 10,
                  ...
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.afar.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "direl", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "dire",
              ...
              o && /* @__PURE__ */ a.jsx("title", { children: o("dire", n.dire) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.dire.x,
              ...
              y && n.dire?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.dire.x,
                  y: s.dire.y + 10,
                  ...
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.dire.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "sidamal", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "sidama",
                  ...
                  onClick: () => c("sidama"),
                  onMouseEnter: () => t("sidama"),
                  onMouseLeave: () => t(null)
                }
              ),
              o && /* @__PURE__ */ a.jsx("title", { children: o("sidama", n.sidama) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.sidama.x,
              ...
              y && n.sidama?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.sidama.x,
                  y: s.sidama.y + 10,
                  ...
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.sidama.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "gambellal", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "gambella",
                  ...
                  onClick: () => c("gambella"),
                  onMouseEnter: () => t("gambella"),
                  onMouseLeave: () => t(null)
                }
              ),
              o && /* @__PURE__ */ a.jsx("title", { children: o("gambella", n.gambella) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.gambella.x,
              ...
              y && n.gambella?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.gambella.x,
                  y: s.gambella.y + 10,
                  ...
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.gambella.value)
                }
              )
            ] }),
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "benishangull", children: [
              /* @__PURE__ */ a.jsx(
                "polygon",
                {
                  id: "benishangul",
                  ...
                  onClick: () => c("benishangul"),
                  onMouseEnter: () => t("benishangul"),
                  onMouseLeave: () => t(null)
                }
              ),
              o && /* @__PURE__ */ a.jsx("title", { children: o("benishangul", n.benishangul) }),
              h && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.benishangul.x,
              ...
              y && n.benishangul?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: s.benishangul.x,
                  y: s.benishangul.y + 15,
                  className: d,
                  textAnchor: "middle",
                  dominantBaseline: "middle",
                  children: u(n.benishangul.value)
                }
              )
            ] })
          ]
      ...
      o && b && /* @__PURE__ */ a.jsx("div", { className: "absolute top-0 left-0 bg-white p-2 rounded shadow", children: o(b, n[b]) })
    ] }),
    /* @__PURE__ */ a.jsx("div", { className: "mt-4", children: /* @__PURE__ */ a.jsx(
      "button",
      {
