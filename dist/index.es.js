...
function s1() {
  ...
  function b(t, f, p) {
    var E = null;
    if (p !== void 0 && (E = "" + p), f.key !== void 0 && (E = "" + f.key), "key" in f) {
      p = {};
      for (var N in f)
        N !== "key" && (p[N] = f[N]);
    } else p = f;
...
function l1() {
  return e1 || (e1 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function b(e) {
      ...
      if (s) {
        s = console;
        var n = s.error, u = typeof Symbol == "function" && Symbol.toStringTag && e[Symbol.toStringTag] || e.constructor.name || "Object";
        return n.call(
          s,
    ...
    function R(e, s, n, u, l, m, g, J) {
      ...
      if (S.call(s, "key")) {
        y = i(e);
        var T = Object.keys(s).filter(function(r1) {
          return r1 !== "key";
        });
        u = 0 < T.length ? "{key: someKey, " + T.join(": ..., ") + ": ...}" : "{key: someKey}", r[y + u] || (T = 0 < T.length ? "{" + T.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (y = null, n !== void 0 && (b(n), y = "" + n), E(s) && (b(s.key), y = "" + s.key), "key" in s) {
        n = {};
        for (var X in s)
          X !== "key" && (n[X] = s[X]);
      } else n = s;
    ...
    var k = n1, w = Symbol.for("react.transitional.element"), L = Symbol.for("react.portal"), A = Symbol.for("react.fragment"), C = Symbol.for("react.strict_mode"), F = Symbol.for("react.profiler"), Q = Symbol.for("react.consumer"), z = Symbol.for("react.context"), H = Symbol.for("react.forward_ref"), q = Symbol.for("react.suspense"), G = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), K = Symbol.for("react.activity"), v = Symbol.for("react.client.reference"), x = k.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, S = Object.prototype.hasOwnProperty, Y = Array.isArray, M = console.createTask ? console.createTask : function() {
      return null;
    };
    k = {
    ...
    P.Fragment = A, P.jsx = function(e, s, n, u, l) {
...
var a1;
function i1() {
  return a1 || (a1 = 1, process.env.NODE_ENV === "production" ? Z.exports = s1() : Z.exports = l1()), Z.exports;
}
var a = i1();
const o1 = [
  {
  ...
  const [j, W] = t1(null), c = $((l) => {
    ...
    ...t[l]?.valueStyle || {}
  }), [t, Y]), n = $((l) => i === l ? p : j === l ? E : t[l]?.color || f, [i, j, t, f, p, E]), u = V(() => b.filter((l) => t[l.id]?.color), [b, t]);
  return /* @__PURE__ */ a.jsxs("div", { className: `${k} flex flex-col lg:flex-row gap-4 p-4`, children: [
    /* @__PURE__ */ a.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ a.jsxs(
        "svg",
        {
          ...
          viewBox: z,
          className: w,
          style: { transform: H ? `scale(${q})` : "none" },
          children: [
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "tigrayl", children: [
              ...
              v && t.tigray?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.tigray.x,
                  y: r.tigray.y + 35,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "addisababal", children: [
              ...
              v && t.addis_ababa?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.addis_ababa.x,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "hararl", children: [
              ...
              v && t.harar?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.harar.x,
                  y: r.harar.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "oromiyal", children: [
              ...
              v && t.oromiya?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.oromiya.x,
                  y: r.oromiya.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "snprl", children: [
              ...
              v && t.snnpr?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.snnpr.x,
                  y: r.snnpr.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "somalial", children: [
              ...
              v && t.somalia?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.somalia.x,
                  y: r.somalia.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "amharal", children: [
              ...
              v && t.amhara?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.amhara.x,
                  y: r.amhara.y + 15,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "afarl", children: [
              ...
              v && t.afar?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.afar.x,
                  y: r.afar.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "direl", children: [
              ...
              v && t.dire?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.dire.x,
                  y: r.dire.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "sidamal", children: [
              ...
              v && t.sidama?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.sidama.x,
                  y: r.sidama.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "gambellal", children: [
              ...
              v && t.gambella?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.gambella.x,
                  y: r.gambella.y + 10,
            ...
            /* @__PURE__ */ a.jsxs("g", { className: "cls-2 state", id: "benishangull", children: [
              ...
              v && t.benishangul?.value !== void 0 && /* @__PURE__ */ a.jsx(
                "text",
                {
                  x: r.benishangul.x,
    ...
    M && u.length > 0 && /* @__PURE__ */ a.jsx("div", { className: "mt-2 pointer-events-none", children: /* @__PURE__ */ a.jsxs("div", { className: "pointer-events-auto p-4 max-w-2xl w-full", children: [
      /* @__PURE__ */ a.jsx("h3", { className: "text-sm font-bold mb-2", children: "Legend" }),
      /* @__PURE__ */ a.jsx("ul", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-x-4 gap-y-2 text-sm", children: u.map((l) => {
        const m = t[l.id]?.color || f;
        return m.startsWith("#") ? `${m.replace("#", "#")}` : `${m}`, /* @__PURE__ */ a.jsxs("li", { className: "flex items-center", children: [
          /* @__PURE__ */ a.jsx(
            "div",
            {
              className: "w-4 h-4 mr-2 flex-shrink-0 rounded border border-gray-300",
              style: { backgroundColor: t[l.id]?.color || f }
            }
          ),
